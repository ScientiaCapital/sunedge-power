      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center bg-secondary/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-secondary/30">
            ...
            <span className="text-sm font-medium">America&apos;s Premier Solar Installation Partner Since 2006</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Powering America with
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
            Specialized expertise in ground mount installations and commercial projects. 
            We offer turnkey installation solutions for solar companies operating across all 50 states.
          </p>
